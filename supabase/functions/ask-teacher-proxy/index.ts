...
function buildPrompt(question: string, context: CardContext): string {
  ...
  return [
    ...
    bareCorrection
      ...
      : [
          "학습자는 토익 영어 문장을 암기하며 공부 중입니다. 한국어로 답변하세요.",
          "- 학습자가 던진 질문에만 답하세요. 단어·표현의 뜻이나 용법을 물으면 그것만 설명하고, 학습자가 입력한 답안과 비교하거나 첨삭하지 마세요. 첨삭은 학습자가 명시적으로 요청할 때만 하세요.",
          "- 이 카드에만 국한하지 말고, 필요하면 관련 문법·용법·예문을 들어도 됩니다.",
          "- 서론·배경 설명·같은 말 반복 없이 핵심만 짧게. 학습자는 긴 답을 안 읽습니다.",
        ].join("\n"),
    "다음 규칙을 지키세요:",
